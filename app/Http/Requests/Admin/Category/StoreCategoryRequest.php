 ...
 *
 * A class defines to store category request validation
 */
class StoreCategoryRequest extends FormRequest
{
    ...
    {
        return [
            'title_ar' => ['required', 'string', 'max:255', 'min:3', 'unique:categories,title_ar'],
            'title_en' => ['required', 'string', 'max:255', 'min:3', 'unique:categories,title_en'],
