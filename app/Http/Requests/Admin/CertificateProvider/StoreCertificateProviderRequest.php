...
/**
 * A class defined for store certificate provider from admin
 */
class StoreCertificateProviderRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            'title_ar' => [
                ...
                'string',
                'max:255',
                'unique:certificate_providers,title_ar'
            ],
            'title_en' => [
                'required',
                'string',
                'max:255',
                'unique:certificate_providers,title_en'
            ],
            'slug' => [
                'sometimes',
                'string',
                'max:255',
                'regex:/^[a-z0-9]+(?:-[a-z0-9]+)*$/',
                'unique:certificate_providers,slug'
            ],
            'description' => [
                'nullable',
                'string',
