 ...
 *
 * A class defines to store country request validation
 */
class StoreCountryRequest extends FormRequest
{
    ...
    {
        return [
            'iso' => ['nullable', 'string', 'max:3', 'unique:countries,iso'],
            'iso3' => ['nullable', 'string', 'max:3', 'unique:countries,iso3'],
            'english_name' => ['required', 'string', 'max:255', 'unique:countries,english_name'],
            'arabic_name' => ['required', 'string', 'max:255', 'unique:countries,arabic_name'],
